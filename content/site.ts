...
export const legalPages = {
  ko: {
    ...
    guide: {
      title: "이미지 최적화 가이드",
      description:
        "이미지 용량 줄이기와 WebP 변환을 할 때 사진 종류와 게시 위치에 맞춰 품질, 크기, 포맷을 선택하는 방법을 안내합니다.",
      label: "Guide",
      paragraphs: [
    ...
    faq: {
      title: "자주 묻는 질문",
      description:
        "이미지 압축, WebP 변환, 결과 파일 다운로드와 브라우저 기반 개인정보 보호 방식에 대해 자주 묻는 질문을 정리했습니다.",
      label: "FAQ",
      paragraphs: [
    ...
    formats: {
      ...
      description:
        "사진, 로고, 투명 배경 이미지, 스크린샷에 맞춰 JPG, PNG, WebP 중 적절한 포맷을 선택하고 결과를 비교하는 기준을 설명합니다.",
      label: "Formats",
      paragraphs: [
    ...
    privacy: {
      title: "개인정보처리방침",
      description:
        "브라우저에서 처리되는 이미지 파일, Vercel Analytics, Google 광고 쿠키와 문의 정보에 적용되는 개인정보 처리 기준을 안내합니다.",
      label: "Privacy",
      paragraphs: [
    ...
    terms: {
      title: "이용약관",
      description:
        "PixelZipKit 이미지 압축 및 WebP 변환 도구를 사용할 때 알아야 할 이용 조건, 파일 권한, 결과 확인과 책임 범위를 안내합니다.",
      label: "Terms",
      paragraphs: [
    ...
    contact: {
      title: "문의하기",
      description:
        "이미지 압축 기능 제안, 오류 제보, 개인정보 처리, 광고 및 제휴 관련 문의를 운영자에게 전달하는 방법을 안내합니다.",
      label: "Contact",
      paragraphs: [
